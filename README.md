...
<img src="https://citeme.app/icon-192.png" width="50" height="50">

An AI-powered academic citation generator that searches 11+ databases (OpenAlex, PubMed, Semantic Scholar, CrossRef) and formats references in 40+ citation styles (APA, ABNT, MLA, Chicago). Available as a web app, Chrome extension, Google Docs add-on, and Word add-in.
